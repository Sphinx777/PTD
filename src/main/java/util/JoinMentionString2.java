...
public class JoinMentionString2 implements FlatMapFunction<Iterator<TweetInfo>,Tuple2<Object, DenseVector<Object>>> {
	//List<Row> tmpMentionList;
    ObjectArrayList<TweetInfo> tweetInfos = new ObjectArrayList<TweetInfo>();
	Date currDate;
	private String model;
    static Logger logger = Logger.getLogger(JoinMentionString2.class.getName());
	CollectionAccumulator<TweetInfo> collectionAccumulator;

	public JoinMentionString2(ObjectArrayList<TweetInfo> oriTweetAccumulator, Date paraCurrDate , String paraModel){
